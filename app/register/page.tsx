    ...
    <main className="min-h-screen flex items-center justify-center bg-amber-50">
      <div className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-md text-center">
        ...
        <p className="text-sm text-gray-400 mb-8">
          We use GitHub to create your account securely. No password needed!
        </p>
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 bg-amber-700 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200"
          >
